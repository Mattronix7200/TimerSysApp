...
Remove-Item -Path .\psd.dat, .\config.json -ErrorAction SilentlyContinue
Stop-Process -Name TimerSys -ErrorAction SilentlyContinue

$ButtonType = [System.Windows.MessageBoxButton]::OK
$MessageboxTitle = "Informacja"
$Messageboxbody = "Ustawienia programu zostaly prawidlowo zresetowane. Mozesz ponownie uruchomic program."
